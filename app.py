...
def generate_excel_from_scratch(format_type, start_dt, end_dt, client_name, product_name, rows, remarks_list, final_budget_val, prod_cost, logo_bytes=None):
    ...
    def render_bolin_optimized(ws, start_dt, end_dt, rows, budget, prod, logo_bytes=None):
        ...
        # (1) Logo (v111.26 Right Align Fix)
        if logo_bytes:
            try:
                ...
                # Align to right edge: anchor to the total_cols column
        ...
        ws.cell(start_footer+1, sig_col_start+1).value = client_name # (2) Party B is Client Name
        ...
        ws.cell(start_footer+2, sig_col_start+2).value = "" # (2) Blank
