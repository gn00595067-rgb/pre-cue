...
# 1. 頁面設定
# =========================================================
st.set_page_config(layout="wide", page_title="Cue Sheet Pro v111.28 (Final Fix)")
    ...
    def render_bolin_optimized(ws, start_dt, end_dt, rows, budget, prod, logo_bytes=None):
        ...
        if logo_bytes:
            try:
                ...
                # Modified here: Anchor to the RIGHTMOST column minus 4 for padding
                # Since we want it roughly "right aligned" but slightly left
